...
class Guild extends Base {
        ...
        if(data.voice_states) {
            if(!client.bot) {
                ...
                for(var voiceState of data.voice_states) {
                    ...
                    try {
                        this.channels.get(voiceState.channel_id).voiceMembers.add(this.members.update(voiceState, this));
                    } catch(err) {
                        continue;
                    }
    ...
    */
    createEmoji(options) {
        return this.shard.client.createGuildEmoji.call(this.id, options);
    }
    ...
    */
    editEmoji(emojiID, options) {
        return this.shard.client.editGuildEmoji.call(this.id, emojiID, options);
    }
    ...
    */
    deleteEmoji(emojiID) {
        return this.shard.client.deleteGuildEmoji.call(this.id, emojiID);
    }
    ...
    */
    getChannels() {
        return this.shard.client.getGuildChannels.call(this.shard.client, this.id);
    }
    ...
    */
    getEmojis() {
        return this.shard.client.getGuildEmojis.call(this.shard.client, this.id);
    }
    ...
    */
    getEmoji(emojiID) {
        return this.shard.client.getGuildEmoji.call(this.shard.client, this.id, emojiID);
    }
    ...
    */
    getMembers(limit, after) {
        return this.shard.client.getGuildMembers.call(this.shard.client, this.id, limit, after);
    }
    ...
    */
    getMember(memberID) {
        return this.shard.client.getGuildMember.call(this.shard.client, this.id, memberID);
    }
    ...
    */
    getRoles() {
        return this.shard.client.getGuildRoles.call(this.shard.client, this.id);
    }
